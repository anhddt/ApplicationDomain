...
export const signInEmailPassword = async (email, password,navigateTo, setErrorMessage) => {
    try {   
...
export const createAccount = async (userInfo, navigateTo, setError, setErrorMessage) => {
    try {
